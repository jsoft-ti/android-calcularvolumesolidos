...
public class PrismaTriangularActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prisma_triangular);
        ...
        this.prismaTriangular = new PrismaTriangular();

    }

    public void calcularVolume(View view){
        this.prismaTriangular.setBase(Double.parseDouble(this.txtBase.getText().toString()));
        this.prismaTriangular.setAlturaBase(Double.parseDouble(this.txtAlturaBase.getText().toString()));
        this.prismaTriangular.setAlturaPrisma(Double.parseDouble(this.txtAlturaPrisma.getText().toString()));
        this.txtResultado.setText(String.valueOf(this.prismaTriangular.calcularVolume()));
    }
}
